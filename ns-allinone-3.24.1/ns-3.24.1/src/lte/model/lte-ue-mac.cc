...
LteUeMac::DoDispose ()
{
 ...
 // std::cout<<"idleTime: "<< idleTime<<std::endl;
  ...
  two(energyDecreasedIdle);
  //three=MakeCallback(&LiIonEnergySource::GetRemainingEnergy, &cb);
  //std::cout<<this<<" Remaining energy: "<<three(void)<<std::endl;
...
LteUeMac::DoTransmitPdu (LteMacSapProvider::TransmitPduParameters params)
{
  ...
  //std::cout<<"energyDecreasedIdle: "<<energyDecreasedIdle<<std::endl;
  //two(energyDecreasedIdle);

  
  double energyDecreasedTx=(0.11+0.306)*supplyVoltage*0.001;
  //std::cout<<"energyDecreasedTx: "<< energyDecreasedTx<<std::endl;
  two(energyDecreasedTx+energyDecreasedIdle);
...
LteUeMac::DoReceivePhyPdu (Ptr<Packet> p)
{
  ...
  //std::cout<<"energyDecreasedRx: "<< energyDecreasedRx<<std::endl;
  two(energyDecreasedRx+energyDecreasedIdle);
