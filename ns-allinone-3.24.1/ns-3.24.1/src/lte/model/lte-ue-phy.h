...
//Added this listener function, not sure about the different notify functions

class LteUePhyListener
{
public:
  virtual ~LteUePhyListener ();

  virtual void NotifyCellSearchStart (Time duration) = 0;
  
  virtual void NotifyCellSearchEndOk (void) = 0;
  
  virtual void NotifyCellSearchEndError (void) = 0;

  virtual void NotifySynchronizedStart (Time duration) = 0;
  
  virtual void NotifySynchronizedEndOk (void) = 0;
  
  virtual void NotifySynchronizedEndError (void) = 0;
...
public:
  ...
  */
  ...
  virtual void RegisterListener (LteUePhyListener *listener);
  virtual void UnregisterListener (LteUePhyListener *listener);
