...
/*LteUePhyListener::~LteUePhyListener ()
{
}
*/
  ...
  if (m_rsrpSinrSampleCounter==m_rsrpSinrSamplePeriod)
    {
     ...
     // std::cout << " cellId " << m_cellId << " rnti " << m_rnti << " RSRP " << rsrp << " SINR " << avSinr << std::endl;
...
void LteUePhy::RegisterListener (LteUePhyListener *listener){
}

void LteUePhy::UnregisterListener (LteUePhyListener *listener){
}
